              ...
              <div className="h-full">
                  <div className="h-full z-10 relative">
                      <div className="flex flex-col flex-1 justify-between h-full space-y-5">
                          ...
                          <div className="pt-2">
                          <CustomButton Value={starter} icon={icon} className="flex items-center gap-2 px-5 py-3 rounded-md hover:shadow-2xl transition-all duration-300 hover:scale-105 appearance-none  font-semibold text-base normal-case"  />
                          </div>
                      </div>
              ...
              <div className="h-full">
                  <div className="h-full z-10 relative">
                      <div className="flex flex-col flex-1 justify-between h-full space-y-5">
                          ...
                          <div className="pt-2">
                          <CustomButton Value={Startup} icon={icon} className="flex items-center gap-2 px-5 py-3 rounded-md hover:shadow-2xl transition-all duration-300 hover:scale-105 appearance-none  font-semibold text-base normal-case"  />
                          </div>
                      </div>
                      <div className="hidden">
                          <ul className="space-y-2 pt-8">
          ...
          <div
              ...
              <div className="h-full">
                  <div className="flex flex-col justify-between h-full space-y-5">
                      ...
                      <div className="pt-2">
                      <CustomButton Value={Enterprise} icon={icon} className="flex items-center gap-2 px-5 py-3 rounded-md hover:shadow-2xl transition-all duration-300 hover:scale-105 appearance-none  font-semibold text-base normal-case"  />
                      </div>
                  </div>
              </div>
          </div>
