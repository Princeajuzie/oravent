...
/**
 * ContactComponent is a functional component that renders the contact section of the website.
 * It displays contact information and social media links.
 *
        ...
        <div className="grid grid-cols-1 gap-x-16 gap-y-8 lg:grid-cols-5">
          <div className="lg:col-span-2 lg:py-12">
            <p className="mt-4 text-gray-600 text-lg">
              Connect with Oravent for personalized and enchanting event
              decorations! We are here to bring your vision to life. Reach out
              to us today.
            </p>

            <div className="mt-8">
              <a
                href="tel: +2348080845305"
            ...
            <div className=" gap-5 text-blue-gray-900 justify-center grid grid-cols-2 ">
              ...
              <Link href="https://www.facebook.com/oramalu.chuks">
                <Typography className="opacity-80 transition-opacity hover:opacity-100 flex items-center gap-5 ">
                  ...
                  <p className="font-bold">Oramalu Chuks</p>
                </Typography>
              </Link>
              ...
              <Link href="https://www.instagram.com/oraventss">
                ...
                >
                  ...
                  <p className="font-bold">Oraventss</p>
                </Typography>
              </Link>

              <Link href="https://wa.me/2348080845305">
                <Typography
                  as="a"
                  className="opacity-80 transition-opacity hover:opacity-100 flex items-center gap-5"
                >
                  <Image src="/wh.svg" height={30} width={30} alt=""></Image>
                  <p className="font-bold">Whatsapp</p>
                </Typography>
              </Link>

              <Link href="https://youtube.com/channel/UCr2rl33GJFW3ir6GfBUHfQw">
                <Typography
                  as="a"
                  className="opacity-80 transition-opacity hover:opacity-100 flex items-center gap-5"
                >
                ...
                >
                  ...
                  <Image src="/yt.svg" height={30} width={30} alt=""></Image>

                  <p className="font-bold">Oraventss The Outlandish Planner</p>
                </Typography>
              </Link>

              <Link href="https://www.tiktok.com/@oraventss?_t=8hW5OtM3ehK&_r=1">
                <Typography
                  as="a"
                  className="opacity-80 transition-opacity hover:opacity-100 flex items-center gap-5"
                >
                  ...
                  <p className="font-bold">@Oraventssk</p>
                </Typography>
              </Link>
              ...
              >
                ...
                <p className="font-bold">oravents@gmail.com</p>
              </Typography>
              </Link>
            </div>
