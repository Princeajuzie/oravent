...
const ContactComponent = () => {
  ...
  <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
    <h2 className="text-3xl font-extrabold text-gray-900 sm:text-4xl p-3">Contact Us</h2>
    <div className="grid grid-cols-1 gap-x-16 gap-y-8 lg:grid-cols-5">
      ...
      <div className=" gap-5 text-blue-gray-900 sm:justify-center grid grid-cols-2">
            <Typography
              as="a"
              href="#"
